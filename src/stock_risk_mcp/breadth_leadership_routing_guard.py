...
_UNSAFE_PATTERNS = (
    ...
    re.compile(r"account(_id|_number)?|broker_order|real_order|order_intent|execution_approval", re.IGNORECASE),
...
def validate_breadth_leadership_routing_metadata_safety(value, *, context: str) -> None:
