...
def main(argv: list[str] | None = None) -> None:
    ...
    commands = {
        ...
        "kiwoom-rest-rank-adapter-check",
        "kiwoom-rest-rank-request-report",
        "kiwoom-rest-rank-mocked-response-report",
        "kiwoom-rest-canonical-rank-report",
        "kiwoom-rest-canonical-outlier-report",
        "kiwoom-rest-rank-continuation-report",
        "kiwoom-rest-rank-readonly-safety-report",
        "kiwoom-rest-rank-v7-integration-report",
        "kiwoom-rest-rank-gap-report",
        "kiwoom-rest-quote-adapter-check",
        "kiwoom-rest-quote-request-report",
        "kiwoom-rest-quote-mocked-response-report",
        "kiwoom-rest-canonical-quote-report",
        "kiwoom-rest-canonical-orderbook-report",
        "kiwoom-rest-liquidity-hint-report",
        "kiwoom-rest-basic-info-report",
        "kiwoom-rest-quote-continuation-report",
        ...
        "kiwoom-rest-sector-adapter-check",
        "kiwoom-rest-sector-request-report",
        "kiwoom-rest-sector-mocked-response-report",
        "kiwoom-rest-canonical-theme-leadership-report",
        "kiwoom-rest-canonical-theme-membership-report",
        "kiwoom-rest-canonical-etf-trend-report",
        "kiwoom-rest-sector-etf-capability-matrix-report",
        "kiwoom-rest-sector-continuation-report",
