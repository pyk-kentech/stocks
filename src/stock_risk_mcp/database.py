...
def create_schema(connection: sqlite3.Connection) -> None:
    connection.executescript(
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_real_readonly_runs (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            run_id TEXT NOT NULL UNIQUE,
            status TEXT NOT NULL,
            run_json TEXT NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_real_readonly_requests (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            request_id TEXT NOT NULL UNIQUE,
            run_id TEXT NOT NULL,
            api_id TEXT NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_real_readonly_responses (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            response_id TEXT NOT NULL UNIQUE,
            request_id TEXT NOT NULL,
            status TEXT NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_account_read_runs (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            run_id TEXT NOT NULL UNIQUE,
            status TEXT NOT NULL,
            run_json TEXT NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_account_read_requests (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            request_id TEXT NOT NULL UNIQUE,
            run_id TEXT NOT NULL,
            endpoint_id TEXT NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_account_read_responses (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            response_id TEXT NOT NULL UNIQUE,
            run_id TEXT NOT NULL,
            endpoint_id TEXT NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_account_read_reconcile_previews (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_account_read_smoke_runs (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            smoke_run_id TEXT NOT NULL UNIQUE,
            status TEXT NOT NULL,
            run_json TEXT NOT NULL,
        ...
        CREATE TABLE IF NOT EXISTS kiwoom_account_read_smoke_steps (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            smoke_step_id TEXT NOT NULL UNIQUE,
            smoke_run_id TEXT NOT NULL,
            endpoint_id TEXT NOT NULL,
