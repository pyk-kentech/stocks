    ...
    return [
        ...
        OfflineStrategyTemplate(
            ...
            parameter_space=OfflineStrategyParameterSpace(
                ...
                parameters=[
                    OfflineStrategyParameter(parameter_name="RSI_PERIOD", dtype="INT", candidate_values=[14]),
        ...
        OfflineStrategyTemplate(
            ...
            parameter_space=OfflineStrategyParameterSpace(
                ...
                parameters=[
                    OfflineStrategyParameter(parameter_name="MACD_FAST", dtype="INT", candidate_values=[12]),
                    OfflineStrategyParameter(parameter_name="MACD_SLOW", dtype="INT", candidate_values=[26]),
                    OfflineStrategyParameter(parameter_name="MACD_SIGNAL", dtype="INT", candidate_values=[9]),
