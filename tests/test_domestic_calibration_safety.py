...
def test_domestic_calibration_core_has_no_forbidden_imports_or_artifact_creation():
    root = Path(__file__).resolve().parents[1] / "src" / "stock_risk_mcp"
    files = (
        "domestic_calibration_models.py",
        "domestic_calibration_fixture.py",
        "domestic_calibration_engine.py",
        "domestic_calibration_service.py",
    )
    forbidden = (
        "database",
        "repository",
