...
def test_domestic_shadow_outcome_core_has_no_forbidden_imports_or_artifact_creation():
    root = Path(__file__).resolve().parents[1] / "src" / "stock_risk_mcp"
    files = (
        "domestic_shadow_outcome_models.py",
        "domestic_shadow_outcome_fixture.py",
        "domestic_shadow_outcome_engine.py",
        "domestic_shadow_outcome_service.py",
    )
    forbidden = (
        "database",
        "repository",
